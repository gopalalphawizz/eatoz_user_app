...
class ConfigModel {
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    //     ?
    //
    //       json['payment_methods'].map((e){
    //         PaymentMethods.fromJson(jsonDecode(e));
    //       }).toList()
    //     : null;
    //
    _paymentMethods =
    ...
    // (json['payment_methods'] is List<dynamic> ?
    // (json['payment_methods'] as List<dynamic>).map((e) {
    //   return PaymentMethods.fromJson(e);
    // })
        // .firstOrNull // Assuming you have an extension method like firstOrNull to safely get the first element of the list, or you can use firstWhere() with a condition
        // : null)
        : null;
