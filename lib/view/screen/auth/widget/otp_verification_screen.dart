...
class VerificationScreen extends StatefulWidget {
  ...
  const VerificationScreen(this.tempToken, this.mobileNumber, this.email, {Key? key, this.fromForgetPassword = false,  this.otp}) : super(key: key);
                            ...
                            onTap: () {
                              if(widget.fromForgetPassword){
                                ...
                                Provider.of<AuthProvider>(context, listen: false).checkPhone(widget.mobileNumber,widget.tempToken, fromResend: true).then((value) {
                                 print('mobile nuber---${widget.mobileNumber}');
                                 print('widgte otp-------${widget.otp}');
                                  print('token----------${widget.tempToken}');
